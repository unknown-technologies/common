...
public abstract class WindowsTextUI extends BasicTextUI {
	/**
	 * Creates the object to use for a caret. By default an instance of WindowsCaret is created. This method can be
	 * redefined to provide something else that implements the InputPosition interface or a subclass of
	 * DefaultCaret.
	 *

...
public final class WindowsTabbedPaneUI extends BasicTabbedPaneUI {
	...
	protected void paintTabBorder(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h,
		...
		if(xp != null) {
			...
			paintRotatedSkin(g, xp.getSkin(tabPane, part), tabPlacement, x, y, width, height, state);
		} else {
			super.paintTabBorder(g, tabPlacement, tabIndex, x, y, width, height, isSelected);
		}
	}

	private static void paintRotatedSkin(Graphics g, Skin skin, int tabPlacement, int x, int y, int w, int h,
			State state) {

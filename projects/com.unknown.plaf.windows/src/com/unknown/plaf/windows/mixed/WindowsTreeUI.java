...
import static com.unknown.plaf.windows.mixed.TMSchema.Part;
import static com.unknown.plaf.windows.mixed.TMSchema.State;
import static com.unknown.plaf.windows.mixed.XPStyle.Skin;
...
public class WindowsTreeUI extends BasicTreeUI {
	...
	public final class WindowsTreeCellRenderer extends DefaultTreeCellRenderer {
		/**
		 * Configures the renderer based on the passed in components. The value is set from messaging the tree
		 * with <code>convertValueToText</code>, which ultimately invokes <code>toString</code> on
		 * <code>value</code>. The foreground color is set based on the selection and the icon is set based on

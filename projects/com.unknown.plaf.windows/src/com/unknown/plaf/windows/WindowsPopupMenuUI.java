...
public final class WindowsPopupMenuUI extends BasicPopupMenuUI {
	...
	static int getTextOffset(JComponent c) {
		...
		if(maxTextOffset instanceof Integer) {
			/*
			 * this is in JMenuItem coordinates. Let's assume all the JMenuItem have the same offset along
			 * X.
			 */
	...
	/**
	 * Checks if PopupMenu is leftToRight The orientation is derived from the children of the component. It is
	 * leftToRight if all the children are leftToRight
	 *
	 * @param c

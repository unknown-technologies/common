...
public final class WindowsButtonUI extends BasicButtonUI {
	...
	static void paintXPButtonBackground(Graphics g, JComponent c) {
		...
		if(b.isContentAreaFilled() && b.getBorder() != null && b.isBorderPainted() && xp != null) {
	...
	/**
	 * returns - b.getBorderInsets(c) if border is opaque - null if border is completely non-opaque - somewhere in
	 * between if border is compound and outside border is opaque and inside isn't
	 */

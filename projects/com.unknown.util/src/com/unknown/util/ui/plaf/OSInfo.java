...
import static com.unknown.util.ui.plaf.OSInfo.OSType.AIX;
import static com.unknown.util.ui.plaf.OSInfo.OSType.LINUX;
import static com.unknown.util.ui.plaf.OSInfo.OSType.MACOSX;
import static com.unknown.util.ui.plaf.OSInfo.OSType.UNKNOWN;
import static com.unknown.util.ui.plaf.OSInfo.OSType.WINDOWS;
...
public class OSInfo {
	public static enum OSType {
		WINDOWS, LINUX, MACOSX, AIX, UNKNOWN
	}

	/*
	 * The map windowsVersionMap must contain all windows version constants except WINDOWS_UNKNOWN, and so the
	 * method getWindowsVersion() will return the constant for known OS. It allows compare objects by "==" instead
	 * of "equals".
	 */
	...
	public static WindowsVersion getWindowsVersion() {
		...
		synchronized(windowsVersionMap) {
			...
			if(result == null) {
				...
				if(arr.length == 2) {
					try {
						result = new WindowsVersion(Integer.parseInt(arr[0]),

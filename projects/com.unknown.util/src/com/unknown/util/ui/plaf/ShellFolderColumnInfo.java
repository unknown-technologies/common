...
public class ShellFolderColumnInfo {
	...
	/**
	 * {@code false} (default) if the {@link #comparator} expects folders as arguments, and {@code true} if folder's
	 * column values. The first option is used default for comparison on Windows and also for separating files from
	 * directories when sorting using ShellFolderManager's inner comparator.
	 */
	...
	/**
	 * This constructor is used by native code when getting column set for a folder under Windows
	 */

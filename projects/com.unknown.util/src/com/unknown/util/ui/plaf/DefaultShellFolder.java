...
class DefaultShellFolder extends ShellFolder {
	...
	/**
	 * This method is implemented to make sure that no instances of {@code ShellFolder} are ever serialized. An
	 * instance of this default implementation can always be represented with a {@code java.io.File} object instead.
	 *
	...
	/**
	 * @return An array of shell folders that are children of this shell folder object, null if this shell folder is
	 *         empty.
	 */
	@Override

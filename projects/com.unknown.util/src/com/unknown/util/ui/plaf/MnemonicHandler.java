...
public final class MnemonicHandler {
	...
	/**
	 * Gets the state of the hide mnemonic flag. This only has meaning if this feature is supported by the
	 * underlying OS.
	 *
	...
	/**
	 * Sets the state of the hide mnemonic flag. This flag is used by the component UI delegates to determine if the
	 * mnemonic should be rendered. This method is a non operation if the underlying operating system does not
	 * support the mnemonic hiding feature.
	 *
	 * @param hide
	...
	/**
	 * Repaints all the components with the mnemonics in container. Recursively searches for all the subcomponents.
	 */

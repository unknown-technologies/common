...
import com.unknown.util.exception.ExceptionIdRegistry;
...
public class ExceptionIdTest {
	...
	public void testResourceNotFound() {
		assertEquals("CEVU0012W: Resource \"the-resource.xml\" not found for class com.unknown.the.clazz",
				Messages.NO_RESOURCE.format("com.unknown.the.clazz", "the-resource.xml"));
	}

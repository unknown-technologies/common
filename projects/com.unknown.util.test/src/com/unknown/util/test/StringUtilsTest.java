...
public class StringUtilsTest {
	...
	public void testFit2() {
		assertEquals("com...tils", StringUtils.fit("com.unknown.util.StringUtils", 10));
	}

	@Test
	public void testFit3() {
		assertEquals("com...tils", StringUtils.fit("com.unknown.utils.StringUtils", 10));
	}

	@Test
	public void testFit4() {
		assertEquals("com....tils", StringUtils.fit("com.unknown.util.StringUtils", 11));
	}

	@Test
	public void testFit5() {
		assertEquals("com....tils", StringUtils.fit("com.unknown.utils.StringUtils", 11));
	}

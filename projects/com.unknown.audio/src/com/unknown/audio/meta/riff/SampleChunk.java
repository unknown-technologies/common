...
public class SampleChunk extends Chunk {
	...
	public void setMidiTune(double cents) {
		double tune = cents / 50.0 * 0x80000000;
		setMidiPitchFraction((int) tune);
	}

	public double getMidiTune() {
		return (double) midiPitchFraction / 0x80000000 * 50.0;
	}

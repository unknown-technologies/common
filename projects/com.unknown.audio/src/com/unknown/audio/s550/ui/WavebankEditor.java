...
import com.unknown.audio.s550.WaveData;
...
public class WavebankEditor extends JPanel {
	...
	public WavebankEditor(FloppyDisk disk) {
		...
		editorA.setCursorColor(0, Color.RED);
		editorB.setCursorColor(0, Color.RED);
		editorA.setCursorTimeVisible(0, true);
		editorB.setCursorTimeVisible(0, true);
		...
		stop.addActionListener(e -> {
			if(player != null) {
				player.stop();
				editorA.setCursorTime(0, 0);
				editorB.setCursorTime(0, 0);
			}
		});

...
import com.unknown.audio.s550.CDImage;
import com.unknown.audio.s550.CDVirtualFloppy;
import com.unknown.audio.s550.FloppyDisk;
import com.unknown.audio.s550.SystemProgram;
...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		newFloppy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, MENU_MASK));
		...
		loadFloppy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, MENU_MASK));
		...
		loadVirtualFloppy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, MENU_MASK));
		...
		loadDisc.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, MENU_MASK));
		...
		saveFloppy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, MENU_MASK));
		...
		midiConfig.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, MENU_MASK));
		JMenuItem exit = new JMenuItem("Exit");
		exit.setMnemonic('x');
		exit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, MENU_MASK));

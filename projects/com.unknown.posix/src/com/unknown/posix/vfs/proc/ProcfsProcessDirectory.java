...
public class ProcfsProcessDirectory extends VFSDirectory {
	...
	public ProcfsProcessDirectory(VFSDirectory parent, long pid, long uid, long gid, long permissions) {
		super(parent, Long.toString(pid), uid, gid, permissions);
		this.pid = pid;
		ctime = new Date();
	}
	...
	private VFSEntry getExe() {
		Posix posix = getPosix();
		return new ProcfsSymlink(this, "exe", 0, 0, 0775, posix.getExecpath());
	}
	...
	private VFSEntry getTasks() {
		return new ProcfsTasksDirectory(this, "task", 0, 0, 0555, pid);
	}

...
public class MotifSplitPaneDivider extends BasicSplitPaneDivider {
	...
	/**
	 * Sets the SplitPaneUI that is using the receiver. This is completely overriden from super to create a
	 * different MouseHandler.
	 */
	@Override
	...
	/**
	 * Returns true if the point at <code>x</code>, <code>y</code> is inside the thumb.
	 */
	...
	/**
	 * MouseHandler is subclassed to only pass off to super if the mouse is in the thumb. Motif only allows dragging
	 * when the thumb is clicked in.
	 */

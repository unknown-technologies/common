...
public class MotifIconFactory implements Serializable {
	...
	private static class CheckBoxIcon implements Icon, UIResource, Serializable {
		...
		public void drawCheckBezelOut(Graphics g, int x, int y, @SuppressWarnings("hiding") int csize) {
			int w = csize;
			int h = csize;
		...
		public void drawCheckBezel(Graphics g, int x, int y, @SuppressWarnings("hiding") int csize,

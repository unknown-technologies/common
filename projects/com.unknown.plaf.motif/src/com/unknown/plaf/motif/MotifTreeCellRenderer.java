...
public class MotifTreeCellRenderer extends DefaultTreeCellRenderer {
	...
	public static class TreeLeafIcon implements Icon, Serializable {
		...
		public void paintIcon(Component c, Graphics g, int x, int y) {
			...
			int py = y - 3;
			g.fillRect(x + 4, py + 7, 5, 5);

			g.drawLine(x + 6, py + 6, x + 6, py + 6);
			g.drawLine(x + 3, py + 9, x + 3, py + 9);
			g.drawLine(x + 6, py + 12, x + 6, py + 12);
			g.drawLine(x + 9, py + 9, x + 9, py + 9);

			g.setColor(highlight);
			g.drawLine(x + 2, py + 9, x + 5, py + 6);
			g.drawLine(x + 3, py + 10, x + 5, py + 12);

			g.setColor(shadow);
			g.drawLine(x + 6, py + 13, x + 10, py + 9);
			g.drawLine(x + 9, py + 8, x + 7, py + 6);
		}

...
public class MotifOptionPaneUI extends BasicOptionPaneUI {
	...
	/**
	 * Creates and returns a Container containin the buttons. The buttons are created by calling
	...
	/**
	 * Creates and adds a JLabel representing the icon returned from <code>getIcon</code> to <code>top</code>. This
	 * is messaged from <code>createMessageArea</code>
	 */
	@Override

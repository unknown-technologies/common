...
public class MotifPopupMenuUI extends BasicPopupMenuUI {
	...
	/*
	 * This has to deal with the fact that the title may be wider than the widest child component.
	 */
	@Override
	...
	protected ChangeListener createChangeListener(@SuppressWarnings("unused") JPopupMenu m) {

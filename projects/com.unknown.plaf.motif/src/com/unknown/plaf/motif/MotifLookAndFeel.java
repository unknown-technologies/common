...
public class MotifLookAndFeel extends BasicLookAndFeel {
	 ...
	 * SystemColor values, otherwise we create color objects whose values match the default CDE/Motif colors.
	 */
	@Override
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		Object menuItemCheckIcon = new UIDefaults.LazyValue() {
			@Override
			public Object createValue(UIDefaults tbl) {
		...
		Object unselectedTabForeground = new UIDefaults.LazyValue() {
			@Override
			public Object createValue(UIDefaults tbl) {
				Color c = tbl.getColor("controlText");
				return new ColorUIResource(Math.max((int) (c.getRed() * .85), 0),
						Math.max((int) (c.getGreen() * .85), 0),
						Math.max((int) (c.getBlue() * .85), 0));
			}
		...
		Object[] defaults = {
			  ...
			  "shift ctrl F12", "navigatePrevious"
				...
				// These are a little odd, MotifInternalFrameUI installs them!
            ...
            // @formatter:on
				...
				"OptionPane.errorIcon", SwingUtilities2.makeXBMIcon(getClass(),
						MotifLookAndFeel.class,
						"icons/xm_error"),
				"OptionPane.informationIcon", SwingUtilities2.makeXBMIcon(getClass(),
						MotifLookAndFeel.class,
						"icons/xm_information"),
				"OptionPane.warningIcon", SwingUtilities2.makeXBMIcon(getClass(),
						MotifLookAndFeel.class,
						"icons/xm_warning"),
				"OptionPane.questionIcon", SwingUtilities2.makeXBMIcon(getClass(),
						MotifLookAndFeel.class,
						"icons/xm_question"),

...
public class MotifTextUI {
	...
	/**
	 * Creates the object to use for a caret for all of the Motif text components. The caret is rendered as an
	 * I-beam on Motif.
	 *
	...
	public static class MotifCaret extends DefaultCaret implements UIResource {
		...
		/**
		 * Called when the component containing the caret gains focus. This is implemented to repaint the
		 * component so the focus rectangle will be re-rendered, as well as providing the superclass behavior.
		 *
		 * @param e
		 *                the focus event
		...
		/**
		 * Called when the component containing the caret loses focus. This is implemented to set the caret to
		 * visibility to false.
		 *
		 * @param e
		 *                the focus event
		...
		/**
		 * Damages the area surrounding the caret to cause it to be repainted. If paint() is reimplemented, this
		 * method should also be reimplemented.
		 *
		 * @param r
		...
		/**
		 * Renders the caret as a vertical line. If this is reimplemented the damage method should also be
		 * reimplemented as it assumes the shape of the caret is a vertical line. Does nothing if isVisible() is
		 * false. The caret color is derived from getCaretColor() if the component has focus, else from
	 ...
	 */
	@SuppressWarnings("deprecation") static final JTextComponent.KeyBinding[] defaultBindings = {

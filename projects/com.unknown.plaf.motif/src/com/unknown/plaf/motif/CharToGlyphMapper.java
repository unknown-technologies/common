...
public abstract class CharToGlyphMapper {
	...
	/*
	 * Default implementations of these methods may be overridden by subclasses which have special requirements or
	 * optimizations
	 */
	...
	public int charToVariationGlyph(int unicode, @SuppressWarnings("unused") int variationSelector) {

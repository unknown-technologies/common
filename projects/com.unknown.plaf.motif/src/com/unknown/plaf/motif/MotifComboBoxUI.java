...
public class MotifComboBoxUI extends BasicComboBoxUI implements Serializable {
	...
	public void paint(Graphics g, JComponent c) {
		boolean focus = comboBox.hasFocus();
		Rectangle r;
	...
	/**
	 * This inner class is marked "public" due to a compiler bug. This class should be treated as a "protected"
	 * inner class. Instantiate it only within subclasses of {@code <FooUI>}.
	 */

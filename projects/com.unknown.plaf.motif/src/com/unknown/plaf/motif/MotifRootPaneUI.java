...
public class MotifRootPaneUI extends BasicRootPaneUI {
	/**
	...
	/**
	 * Constructs a {@code MotifRootPaneUI}.
	 */
	public MotifRootPaneUI() {
	}
	 ...
	 */
	void installBorder(JRootPane pane) {
		...
		if(style == JRootPane.NONE) {
			...
			if(frameBorder == null || frameBorder instanceof UIResource) {
				pane.setBorder(new MotifBorders.RootPaneBorder(pane));
			}
	...
	private JComponent createTitlePane(JRootPane rootPane) {
		return new MotifTitlePane(rootPane, this);
	}
	...
	/**
	 * Invoked when a property changes. <code>MotifRootPaneUI</code> is primarily interested in events originating
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		if(propertyName.equals("windowDecorationStyle")) {
			...
			// simpler. MotifTitlePane also assumes it will be recreated if
	...
	private static class MotifRootLayout implements LayoutManager2 {
		/**
		...
		public Dimension preferredLayoutSize(Container parent) {
			...
			if(root.getWindowDecorationStyle() != JRootPane.NONE &&
					(root.getUI() instanceof MotifRootPaneUI)) {
				JComponent titlePane = ((MotifRootPaneUI) root.getUI()).getTitlePane();
				if(titlePane != null) {
